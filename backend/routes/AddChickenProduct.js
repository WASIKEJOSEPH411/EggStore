...
// Get a single chicken product by ID
router.get("/chicken/:id", async (req, res) => {
    try {
        const product = await ChickenProduct.findById(req.params.id);
        if (!product) {
...
// Update a product
router.put("/addchickenproduct/:id", upload.single("image"), async (req, res) => {
    try {
...
// Delete a product
router.delete("/addchickenproduct/:id", async (req, res) => {
    try {
